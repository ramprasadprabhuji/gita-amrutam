...
const VERSES = {
  "1-1": {
    ...
    pratipadartham:[
      {word:"ధర్మక్షేత్రే", breakdown:"ధర్మ + క్షేత్రే", meaning:"ధర్మభూమి యందు"},
      {word:"కురుక్షేత్రే", breakdown:"కురు + క్షేత్రే", meaning:"కురుక్షేత్రమునందు"},
      {word:"సమవేతాః", breakdown:"సమ + అవేతాః", meaning:"సమకూడిన"},
      {word:"యుయుత్సవః", breakdown:"యుద్ధం చేయుటకు ఇచ్ఛ గల", meaning:"యుద్ధానికి సిద్ధమైన"},
      {word:"మామకాః", breakdown:"మమ + కాః", meaning:"నా పుత్రులు (కౌరవులు)"},
      {word:"పాండవాః", breakdown:"పాండవాః", meaning:"పాండు పుత్రులు"},
      {word:"చ ఏవ", breakdown:"చ + ఏవ", meaning:"మరియు నిశ్చయంగా"},
      {word:"కిమ్", breakdown:"కిమ్", meaning:"ఏమి"},
      {word:"అకుర్వత", breakdown:"అ + కుర్వత", meaning:"చేశారు"},
      {word:"సంజయ", breakdown:"సంజయ", meaning:"ఓ సంజయా!"}
    ],
